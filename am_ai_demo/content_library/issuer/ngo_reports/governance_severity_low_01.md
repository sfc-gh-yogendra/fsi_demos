...
variant_id: gov_low_01
category: governance
severity: low
word_count_target: 520
placeholders:
  required:
    - ISSUER_NAME
    - TICKER
...
{{NGO_NAME}} has reviewed the board composition and governance practices at {{ISSUER_NAME}}. Our assessment identifies opportunities for enhancement in board diversity and committee structure, which we classify as **low severity**. The company demonstrates generally sound governance practices with established policies and procedures, though improvements would align practices more closely with emerging best practices.
...
{{NGO_NAME}} assesses {{ISSUER_NAME}}'s governance as generally sound with **low severity** areas for enhancement. The company meets regulatory requirements and demonstrates commitment to governance standards. Implementation of our recommendations would position the company as governance leader.

---

*{{NGO_NAME}} is fictional. Assessment illustrative for SAM demo.*
